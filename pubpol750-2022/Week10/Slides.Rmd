...
- Almost all the time, weights either have a mean of 1 or sum to 1. Sometimes weight sum to the population, but this is rarer.
- Weights with a mean of one mean that this is how much the respondent is worth in that sample.
...
- It doesn't change any of your analyses. 

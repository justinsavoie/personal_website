...
Plot the number of male and female MPs per time period. Save as figure3 (not shown).
...
Plot the number of male and female MPs per time period and party. Save as figure4 (not shown).
...
Transform the party variable so that all the various "Conservative" parties are together mapped to "Conservative". Then rerun the last figure. Save as figure5.

```{r, eval=FALSE}
Parliamentarians <- mutate(Parliamentarians,recode(party,!!!c("Conservative Party of Canada"="Conservative",

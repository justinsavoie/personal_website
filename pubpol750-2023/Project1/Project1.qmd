...
```{r}
df$age_range <- as_factor(df$age_range)
```
...
df <- df |>
  mutate(vote_coalesced=as_factor(vote_coalesced))
...
Very succinctly, comment each figure.